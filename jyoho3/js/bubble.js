...
* image elements with -radius CSS.
...
google.bookmarkbubble.Bubble.prototype.build_ = function () {
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    /*bubbleInner.innerHTML = 'Your phone should be kept horizontal.: ' +
        'Or please check by computer.';*/
    bubbleInner.innerHTML = 'サイトは横画面推奨です。' +
        '又はPC上から御覧ください！';
  } else {
    /*bubbleInner.innerHTML = 'Your phone should be kept horizontal.: ' +
        'Or please check by PC.';*/
    bubbleInner.innerHTML = 'このサイトは横画面推奨です。' +
        '又はPC上から御覧ください！';
  }
